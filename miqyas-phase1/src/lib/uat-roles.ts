  ...
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        dimensions: ["نطاق"],
        steps: ["من تبويب المعتمد نهائيًا: ألغِ الاعتماد بسبب", "أعد فحص اللوحة"],
        expected: "يختفي من التحليل · الحالة SUBMITTED أو DRAFT حسب المدخل · ملاحظات ظاهرة للمدير/المالك",
      },
      {
        id: "sa-04",
        n: 4,
  ...
  },
  {
    ...
    cases: [
      ...
      },
      {
        id: "e2e-04",
        n: 4,
        title: "إلغاء نهائي → اختفاء من التحليل وعودة للمدير",
        dimensions: ["نطاق"],
        steps: [
          "المشرف يلغي الاعتماد النهائي بسبب واضح",
          "افحص اللوحات",
          "افحص /dept-follow للمدير و/my للمالك",
        ],
        expected: "يختفي من التحليل · المدير يرى بانتظار/ملاحظات · المالك لا يُقفل إن أُعيد للتعديل حسب القاعدة",
      },
      {
        id: "e2e-05",
        n: 5,
  ...
  },
  {
    ...
    cases: [
      ...
      },
      {
        ...
        dimensions: ["نطاق"],
        steps: ["مشرف يلغي", "افحص المالك والمدير"],
        expected: "المدير يُشعَر بـ /dept-follow إن أُعيد SUBMITTED · المالك بـ /my إن بقي مالكًا",
      },
    ],
  },
];
